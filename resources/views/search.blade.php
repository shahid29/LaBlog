...
@section('content')
    <div class="slider display-table center-text">
        <h1 class="title display-table-cell"><b>{{$posts->count()}} result found this <strong style="color: red">{{$query}}</strong> query</b></h1>
    </div><!-- slider -->
                        ...
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-info">
                                    ...
                                    <h4 class="title">Sorry, No post found this <strong style="color: red">{{$query}}</strong> query</h4>
